...
@Component
@ConfigurationProperties(value = "mwd.brewery", ignoreUnknownFields = false)
public class BreweryClient {
    ...
    public void updateBeer(UUID uuid, BeerDto beerDto) {
        restTemplate.put(apihost + BEER_PATH_V1  + uuid.toString()
        , beerDto);
    }
    ...
    public CustomerDto gerCustomerById(UUID uuid) {
